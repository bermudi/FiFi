...
public class TestMain {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        Team team7 = new Team("Chelsea FC", 5f);
        Team team8 = new Team("Tottenham Hotspur", 5f);
        Team team9 = new Team("Milan AC", 5f);
        Team team10 = new Team("Juventus FC", 5f);
        Team team11 = new Team("Inter Milan", 5f);
        Team team12 = new Team("Paris Saint Germain", 5f);
        Team team13 = new Team("Atletico Madrid", 5f);
        Team team14 = new Team("Borussia Dortmund", 5f);
        Team team15 = new Team("FC Bayern Munich", 5f);
        Team team16 = new Team("Galatasaray SK", 5f);
        ...
        TeamManager.saveTeam(team7);
        TeamManager.saveTeam(team8);
        TeamManager.saveTeam(team9);
        TeamManager.saveTeam(team10);
        TeamManager.saveTeam(team11);
        TeamManager.saveTeam(team12);
        TeamManager.saveTeam(team13);
        TeamManager.saveTeam(team14);
        TeamManager.saveTeam(team15);
        TeamManager.saveTeam(team16);
